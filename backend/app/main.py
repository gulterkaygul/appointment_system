...
# CORS Ayarları - Frontend erişimi için burayı güncelledik
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost:5173",
        "http://127.0.0.1:5173",
        "http://localhost:3000", # Alternatif portlar için
        "http://127.0.0.1:3000",
    ],
...
app.include_router(chatbot.router) # Chatbot router'ı burada aktif
